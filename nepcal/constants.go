...
// month and days.
// Invariant: the AD and BS lower bounds are the effective same date.
const (
	adLBoundY = 1918
	...
	// Also change the AD upper bounds if these values need to be updated.
	bsUBoundY = 2100
	bsUBoundM = 12
	bsUBoundD = 30

	adUBoundY = 2044
	adUBoundM = int(time.April)
	adUBoundD = 12
)
...
var bsDaysInMonthsByYear = map[int][]int{
	bsLBoundY: {31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30},
	...
	bsUBoundY: {31, 32, 31, 32, 30, 31, 30, 29, 30, 29, 30, 30},
}
